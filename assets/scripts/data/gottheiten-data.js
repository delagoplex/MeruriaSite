...
window.GODS_DATA = {
  ...
  gods: [
    ...
    },
    {
      ...
      insigniaSrc: "assets/images/insignia/Insignie_Elysarion.png",
    ...
    },
    {
      ...
      insigniaSrc: "assets/images/insignia/Insignie_Sienna.png",
    ...
    },
    {
      ...
      insigniaSrc: "assets/images/insignia/Insignie_Avalaste.png",
 ...
 symbolSvg: `<svg viewBox="0 0 80 80" fill="none"><polygon points="40,10 55,35 40,30 25,35" stroke="currentColor" stroke-width="1.5" fill="none"/><polygon points="40,28 58,55 40,48 22,55" stroke="currentColor" stroke-width="1.5" fill="none"/><line x1="40" y1="55" x2="40" y2="70" stroke="currentColor" stroke-width="2"/><line x1="32" y1="65" x2="48" y2="65" stroke="currentColor" stroke-width="1.5"/></svg>`, description: LOREM_SHORT, lore: LOREM_LORE, symbol: "Waldatem", alignment: "Neutral Good", worshippers: LOREM_SHORT },
    { id: "ng-steingeist",  name: "Steingeist",  title: "Stimme des Gebirges",       domain: "Stein · Ausdauer · Tiefe",    palette: ["#101010","#252525","#555555","#b0b0b0"], insigniaSrc: "assets/images/insignia/Insignie_Aurelia.png",
 symbolSvg: `<svg viewBox="0 0 80 80" fill="none"><polygon points="40,12 68,60 12,60" stroke="currentColor" stroke-width="1.5" fill="none"/><polygon points="40,28 56,56 24,56" stroke="currentColor" stroke-width="1" fill="none" opacity="0.5"/><circle cx="40" cy="46" r="5" stroke="currentColor" stroke-width="1"/></svg>`, description: LOREM_SHORT, lore: LOREM_LORE, symbol: "Erdgedächtnis", alignment: "True Neutral", worshippers: LOREM_SHORT },
    { id: "ng-flussgeist",  name: "Flussgeist",  title: "Stimme des fließenden Wassers", domain: "Wasser · Bewegung · Zeit", palette: ["#050f20","#0a2040","#1a5080","#60b0e0"], insigniaSrc: "assets/images/insignia/Insignie_Aurelia.png",
 symbolSvg: `<svg viewBox="0 0 80 80" fill="none"><path d="M14 35 Q27 25 40 35 Q53 45 66 35" stroke="currentColor" stroke-width="1.5" fill="none"/><path d="M14 45 Q27 35 40 45 Q53 55 66 45" stroke="currentColor" stroke-width="1.2" fill="none" opacity="0.7"/><path d="M14 55 Q27 45 40 55 Q53 65 66 55" stroke="currentColor" stroke-width="1" fill="none" opacity="0.4"/></svg>`, description: LOREM_SHORT, lore: LOREM_LORE, symbol: "Strömung", alignment: "True Neutral", worshippers: LOREM_SHORT },
    { id: "ng-windgeist",   name: "Windgeist",   title: "Atem des freien Himmels",   domain: "Wind · Freiheit · Wandel",    palette: ["#080f18","#101e30","#204060","#80b0d0"], insigniaSrc: "assets/images/insignia/Insignie_Aurelia.png",
 symbolSvg: `<svg viewBox="0 0 80 80" fill="none"><path d="M15 30 Q30 20 40 30 Q50 40 65 30" stroke="currentColor" stroke-width="1.5"/><path d="M15 40 Q30 30 40 40 Q50 50 65 40" stroke="currentColor" stroke-width="1.2" opacity="0.7"/><path d="M15 50 Q30 40 40 50 Q50 60 65 50" stroke="currentColor" stroke-width="1" opacity="0.4"/><circle cx="15" cy="40" r="2" fill="currentColor" opacity="0.5"/></svg>`, description: LOREM_SHORT, lore: LOREM_LORE, symbol: "Windstimme", alignment: "Chaotic Good", worshippers: LOREM_SHORT },
    { id: "ng-feuergeist",  name: "Feuergeist",  title: "Glut der Urkraft",          domain: "Feuer · Erneuerung · Licht",  palette: ["#180800","#402000","#904010","#e08030"], insigniaSrc: "assets/images/insignia/Insignie_Aurelia.png",
 symbolSvg: `<svg viewBox="0 0 80 80" fill="none"><path d="M40 65 C25 55 18 42 26 30 C30 24 36 28 34 36 C40 28 44 16 52 22 C60 28 58 50 40 65Z" stroke="currentColor" stroke-width="1.5" fill="none"/><circle cx="40" cy="48" r="6" stroke="currentColor" stroke-width="1"/></svg>`, description: LOREM_SHORT, lore: LOREM_LORE, symbol: "Urglut", alignment: "Chaotic Neutral", worshippers: LOREM_SHORT },
  ],
};
