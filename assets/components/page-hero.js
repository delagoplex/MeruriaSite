...
function PageHero({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      background: 'linear-gradient(180deg,rgba(16,10,40,0.85) 0%,rgba(7,6,26,0.95) 100%)'
    }
    ...
    style: {
      ...
      width: '70px',
      height: '1px',
      background: 'linear-gradient(to right,rgba(124,77,255,0.5),transparent)'
    }
    ...
    style: {
      ...
      letterSpacing: '0.2em',
      color: '#f0eeff',
      textShadow: '0 0 28px rgba(124,77,255,0.28)',
      lineHeight: 1.1,
      textTransform: 'uppercase',
      margin: '0 0 9px'
    }
    ...
    style: {
      width: '90px',
      height: '1px',
      background: 'linear-gradient(to right,rgba(124,77,255,0.45),transparent)'
    }
    ...
    style: {
      ...
      right: 0,
      height: '32px',
      background: 'linear-gradient(transparent,rgba(5,4,15,0.6))',
      pointerEvents: 'none'
    }
  }));
}
