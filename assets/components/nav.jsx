...
const NAV = [
  { id: 'einleitung', label: 'Einleitung', items: [{ label: 'Informationen', href: 'Informationen.html' }, { label: 'Vorgeschichte', href: 'Vorgeschichte.html' }, { label: 'Sitzung Null', href: '#'}] },
  { id: 'spielerhandbuch', label: 'Spielerhandbuch', href: 'Spielerhandbuch.html', items: [{ label: 'Realismus', href: 'Realismus Standalone.html' }, { label: 'Sammeln & Handwerk', href: 'Sammeln und Handwerk.html' }, { label: 'Schutzherren', href: '#'}, { label: 'Gesinnungen', href: '#'}, { label: 'Regierungsformen', href: '#'}] },
  ...
  { id: 'enzyklopaedie', label: 'Enzyklopädie', href: 'Enzyklopädie.html', items: [{ label: 'Völker', href: '#' }, { label: 'Orte', href: '#' }, { label: 'Ressourcen', href: 'Ressourcen.html' }, { label: 'Organisationen', href: '#' }, { label: 'Gottheiten', href: 'Gottheiten.html' }, { label: 'Kalender', href: 'Kalender.html' },{ label: 'Religionen', href: '#' }, { label: 'Monster', href: 'Monster.html', locked: true, dividerAfter: true, glitch: false }, { label: 'Kollektikon', href: 'Kollektikon.html' }, { label: 'Galerie', href: 'Galerie.html', highlight: true }] },
  ...
  { id: 'tools', label: 'Tools', items: [{ label: 'Steckbrief', href: 'Steckbrief.html', glitch: false }, { label: 'Missionsterminal', href: 'Missionsterminal.html' }, { label: 'Tarot', href: 'Tarot.html' }, { label: 'Kampfsimulation', href: 'Kampfsimulation.html', locked: true }] }
];
