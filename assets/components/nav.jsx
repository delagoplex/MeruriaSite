...
const NAV = [
  ...
  { id: 'tools', label: 'Spiel', items: [{ label: 'Kollektikon', href: 'Kollektikon.html' }, { label: 'Karte', href: 'Karte.html' }, { label: 'Kalender', href: 'Kalender.html' }, { label: 'Steckbrief', href: 'Steckbrief.html', glitch: false }, { label: 'Missionsterminal', href: 'Missionsterminal.html' }] },
